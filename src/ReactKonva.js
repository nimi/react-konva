...
KonvaProperty.injectKonvaProperties(
  KonvaPropertyConfig.KonvaPropertyConfig,
  KonvaHierarchy,
  KonvaPropertyConfig.KonvaEvents
);
...
for (var konvaClass in KonvaHierarchy) {
  if (!excludeClasses[konvaClass]) {
    module.exports[konvaClass] = KonvaFactory.createSimpleClass(
      konvaClass,
      containerClasses[konvaClass],
      layerClasses[konvaClass]
    );
  }
}
